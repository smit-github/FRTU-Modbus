...
extern const uint16_t DO_FRTU_PART1_REGISTERS_ADDRESS;
extern const uint16_t DO_FRTU_PART1_REGISTERS_NB ;
extern const uint16_t DO_FRTU_PART1_REGISTERS_NB_MAX;
extern const uint16_t DO_FRTU_PART1_REGISTERS_TAB[];

extern const uint16_t DO_FRTU_PART2_REGISTERS_ADDRESS;
extern const uint16_t DO_FRTU_PART2_REGISTERS_NB ;
extern const uint16_t DO_FRTU_PART2_REGISTERS_NB_MAX;
extern const uint16_t DO_FRTU_PART2_REGISTERS_TAB[];

extern const uint16_t DO_FRTU_PART3_REGISTERS_ADDRESS;
extern const uint16_t DO_FRTU_PART3_REGISTERS_NB ;
extern const uint16_t DO_FRTU_PART3_REGISTERS_NB_MAX;
extern const uint16_t DO_FRTU_PART3_REGISTERS_TAB[];

extern const uint16_t DO_FRTU_PART4_REGISTERS_ADDRESS;
extern const uint16_t DO_FRTU_PART4_REGISTERS_NB ;
extern const uint16_t DO_FRTU_PART4_REGISTERS_NB_MAX;
extern const uint16_t DO_FRTU_PART4_REGISTERS_TAB[];
